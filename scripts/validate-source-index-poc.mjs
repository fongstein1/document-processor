...
const main = async () => {
  ...
  if (vm31SourcePackage.processing?.reviewOnly !== true || vm31SourcePackage.processing?.promotionStatus !== 'not_promoted' || vm31SourcePackage.chunks.length !== 84 || vm31SourcePackage.chunks.filter((chunk) => chunk.chunkLevel === 'parent').length !== 9 || vm31SourcePackage.chunks.filter((chunk) => chunk.chunkLevel === 'child').length !== 75 || vm31SourcePackage.chunks.some((chunk) => chunk.promotionEligible !== false)) fail('VM-31 canonical review-candidate metadata or hierarchy is incomplete.')
