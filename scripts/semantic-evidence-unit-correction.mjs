...
export const buildSemanticEvidenceCorrection = async ({ output = publicRoot, external = externalRoot } = {}) => {
  ...
  const goldPath = path.join(external, 'gold-v2-adjudication.json'); const goldBytes = await fs.readFile(goldPath)
