...
assert(changes.every(p=>p.startsWith(`data/processed/review_packages/${runId}/`)||p.startsWith('data/processed/review_packages/multi-unit-gold-v1-2026-09/')||p.startsWith('data/processed/review_packages/multi-unit-sidecar-hardening-2026-09/')),'Historical processed artifacts changed')
