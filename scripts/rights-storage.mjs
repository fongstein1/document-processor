...
const prohibitedKeys = new Set(['sourceTextExcerpt', 'normalizedTextExcerpt', 'normalizedSearchText', 'sourceText', 'text', 'value', 'values', 'formula', 'query', 'queryText', 'goldRationale', 'parentContextText', 'headerText', 'contextPackageText', 'bm25Vocabulary', 'keywords', 'keyPoints', 'concepts', 'definedTerms', 'requirements', 'duplicateLabelValues', 'titleCandidates', 'headingCandidates', 'sectionBoundaryCandidates', 'tableRows', 'tableValues', 'reconstructedTable', 'sourceDerivedText', 'sourceTextArray', 'normalizedTextArray', 'unexpectedContent'])
