...
for (const key of ['allowedAuthoringSources', 'allowedTaskCategories', 'allowedSourceFamilyHints']) safeStringArrayKeys.add(key)
for (const key of [
...
for (const key of [
  'NATURAL_QUESTION_GOLD_V1', 'questionInputPath', 'questionInputExists', 'questionTextExternal',
  'questionCount', 'humanQuestionCount', 'targetBlindSecondaryCount', 'targetQuestionInputCount',
  'minimumQuestionInputCount', 'minimumHumanQuestionCount', 'questionShortfall',
  'minimumQuestionShortfall', 'humanQuestionShortfall', 'inputValidationPassed', 'phaseAGatePassed',
  'adjudicationStarted', 'goldFrozen', 'baselineEvaluationRun', 'modelSelected',
  'modelSelectionAllowed', 'modelImplementationAllowed', 'modelEvaluationAllowed', 'stopReason',
  'INSUFFICIENT_NATURAL_QUESTIONS', 'PRIVATE_TARGET_INDEPENDENT_QUESTION_INPUT',
  'requiredNextInput', 'consumedHoldoutsUsed', 'historicalGoldChanged', 'retrievalChanged',
  'modelChanged', 'sourceAcquisitionPerformed', 'canonicalPromotionPerformed',
  'answerLayerBuilt', 'hostedApiUsed', 'targetQuestionInputCount', 'minimumQuestionInputCount',
  'minimumHumanQuestionCount', 'targetSupportedRange', 'targetUnsupportedRange',
  'allowedAuthoringSources', 'allowedTaskCategories', 'allowedSourceFamilyHints',
  'minimumQuestionCharacters', 'maximumQuestionCharacters',
  'adjudicationMayBeginOnlyAfterQuestionFreeze', 'modelSelectionAllowedBeforeGoldFreeze'
]) safeKeys.add(key)
...
for (const key of [
  'SECTION_CHALLENGE_V1', 'supported', 'diagnostic', 'matchedPairs', 'splitCounts', 'structuralClassCounts',
  'identifierPresence', 'phrasing', 'seedReachabilityClass', 'candidateCutoffs', 'bm25Cutoff', 'vectorCutoff', 'hybridCutoff', 'reachabilityCutoffs',
  'evaluationMetrics', 'successThresholds', 'damageBudget', 'structuralScoreBounds', 'normalization',
  'formulaCode', 'unionMissingRank', 'identifierAbsentTargetTop1AbsoluteImprovementMinimum',
  'parentTop1AbsoluteImprovementMinimum', 'wrongSectionRescuesMinimum', 'netWrongSectionRescuesMinimum',
  'previouslyCorrectTop1LostMaximumCount', 'previouslyCorrectTop1LostMaximumRate',
  'sourceTop1AbsoluteRegressionMaximum', 'sourceCorrectToWrongMaximumCount',
  'identifierPresentTop1AbsoluteRegressionMaximum', 'identifierPresentDamagedMaximumCount',
