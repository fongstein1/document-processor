...
const paths = {
  ...
  ag36LawManualReprintBatchPlanJson: path.join(repoRoot, 'config', 'ag36-law-manual-reprint-batch-plan.json'),
  ag36LawManualReprintExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'ag36_law_manual_reprint_extraction_plan.md'),
  ag36LawManualReprintReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'ag36_law_manual_reprint_review_index.md'),
  ag36LawManualReprintSelfReviewMd: path.join(repoRoot, 'docs', 'review', 'ag36_law_manual_reprint_self_review.md'),
  ...
  ag37LawManualReprintBatchPlanJson: path.join(repoRoot, 'config', 'ag37-law-manual-reprint-batch-plan.json'),
  ag37LawManualReprintExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'ag37_law_manual_reprint_extraction_plan.md'),
  ag37LawManualReprintReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'ag37_law_manual_reprint_review_index.md'),
  ag37LawManualReprintSelfReviewMd: path.join(repoRoot, 'docs', 'review', 'ag37_law_manual_reprint_self_review.md'),
  ...
  ag38LawManualReprintBatchPlanJson: path.join(repoRoot, 'config', 'ag38-law-manual-reprint-batch-plan.json'),
  ag38LawManualReprintExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'ag38_law_manual_reprint_extraction_plan.md'),
  ag38LawManualReprintReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'ag38_law_manual_reprint_review_index.md'),
  ag38LawManualReprintSelfReviewMd: path.join(repoRoot, 'docs', 'review', 'ag38_law_manual_reprint_self_review.md'),
  ...
  ag48LawManualReprintBatchPlanJson: path.join(repoRoot, 'config', 'ag48-law-manual-reprint-batch-plan.json'),
  ag48LawManualReprintExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'ag48_law_manual_reprint_extraction_plan.md'),
  ag48LawManualReprintReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'ag48_law_manual_reprint_review_index.md'),
  ag48LawManualReprintSelfReviewMd: path.join(repoRoot, 'docs', 'review', 'ag48_law_manual_reprint_self_review.md'),
  ...
  reg151BatchPlanJson: path.join(repoRoot, 'config', 'reg151-batch-plan.json'),
  reg151ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg151_extraction_plan.md'),
  reg151ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg151_review_index.md'),
  reg151SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg151_self_review.md'),
  reg147BatchPlanJson: path.join(repoRoot, 'config', 'reg147-batch-plan.json'),
  reg147ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg147_extraction_plan.md'),
  reg147ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg147_review_index.md'),
  reg147SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg147_self_review.md'),
  reg126BatchPlanJson: path.join(repoRoot, 'config', 'reg126-batch-plan.json'),
  reg126ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg126_extraction_plan.md'),
  reg126ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg126_review_index.md'),
  reg126SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg126_self_review.md'),
  reg056BatchPlanJson: path.join(repoRoot, 'config', 'reg056-batch-plan.json'),
  reg056ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg056_extraction_plan.md'),
  reg056ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg056_review_index.md'),
  reg056SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg056_self_review.md'),
  ...
  reg143BatchPlanJson: path.join(repoRoot, 'config', 'reg143-batch-plan.json'),
  reg143ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg143_extraction_plan.md'),
  reg143ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg143_review_index.md'),
  reg143SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg143_self_review.md'),
  reg136BatchPlanJson: path.join(repoRoot, 'config', 'reg136-batch-plan.json'),
  reg136ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg136_extraction_plan.md'),
  reg136ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg136_review_index.md'),
  reg136SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg136_self_review.md'),
  reg179BatchPlanJson: path.join(repoRoot, 'config', 'reg179-batch-plan.json'),
  reg179ExtractionPlanMd: path.join(repoRoot, 'docs', 'processor', 'reg179_extraction_plan.md'),
  reg179ReviewIndexMd: path.join(repoRoot, 'docs', 'review', 'reg179_review_index.md'),
  reg179SelfReviewMd: path.join(repoRoot, 'docs', 'review', 'reg179_self_review.md'),
...
if (problems.length > 0) {
  ...
  const ag36ReviewArtifactsPresent =
    ...
    await validateAg18PlanMarkdown(
      paths.ag36LawManualReprintExtractionPlanMd,
      'docs/processor/ag36_law_manual_reprint_extraction_plan.md',
    )
    const ag36LawManualReprintBatchPlan = await readJson(paths.ag36LawManualReprintBatchPlanJson)
    const ag36LawManualReprintBatchIds = ag36LawManualReprintBatchPlan.proposedBatches.map(
      (batch) => batch.plannedBatchId,
    )
    const ag36LawManualReprintReviewIndexText = (await exists(paths.ag36LawManualReprintReviewIndexMd))
      ? await readText(paths.ag36LawManualReprintReviewIndexMd)
      : ''
    const ag36LawManualReprintSelfReviewText = (await exists(paths.ag36LawManualReprintSelfReviewMd))
      ? await readText(paths.ag36LawManualReprintSelfReviewMd)
      : ''
    const ag36LawManualReprintPocSummaryText = (await exists(paths.pocStatusSummaryMd))
      ? await readText(paths.pocStatusSummaryMd)
      : ''
    const ag36LawManualReprintReviewIndexReady =
      ag36LawManualReprintReviewIndexText.length > 0 &&
      ag36LawManualReprintBatchIds.every((batchId) =>
        ag36LawManualReprintReviewIndexText.includes(batchId),
      )
    const ag36LawManualReprintSelfReviewReady =
      ag36LawManualReprintSelfReviewText.length > 0 &&
      ag36LawManualReprintBatchIds.every((batchId) =>
        ag36LawManualReprintSelfReviewText.includes(batchId),
      )
    const ag36LawManualReprintReviewArtifactsPresent =
      ag36LawManualReprintReviewIndexReady && ag36LawManualReprintSelfReviewReady
    const ag36LawManualReprintPocSummaryReady =
      ag36LawManualReprintPocSummaryText.includes(
        'docs/review/ag36_law_manual_reprint_review_index.md',
      ) &&
      ag36LawManualReprintPocSummaryText.includes(
        'docs/review/ag36_law_manual_reprint_self_review.md',
      ) &&
      ag36LawManualReprintPocSummaryText.includes('97 review indexes')
    if (ag36LawManualReprintReviewArtifactsPresent && !ag36LawManualReprintPocSummaryReady) {
      problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing AG 36 Law Manual reprint review index reference')
    }
    if (ag36LawManualReprintReviewIndexReady) {
      console.log(
        `- AG 36 Law Manual reprint review index verified: ${ag36LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    if (ag36LawManualReprintSelfReviewReady) {
      console.log(
        `- AG 36 Law Manual reprint self-review verified: ${ag36LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    console.log(
      `- AG 36 Law Manual reprint plan verified: ${ag36LawManualReprintBatchPlan.proposedBatches.length} batches`,
    )
    if (ag37ReviewArtifactsPresent) {
    ...
    await validateAg18PlanMarkdown(
      paths.ag37LawManualReprintExtractionPlanMd,
      'docs/processor/ag37_law_manual_reprint_extraction_plan.md',
    )
    const ag37LawManualReprintBatchPlan = await readJson(paths.ag37LawManualReprintBatchPlanJson)
    const ag37LawManualReprintBatchIds = ag37LawManualReprintBatchPlan.proposedBatches.map(
      (batch) => batch.plannedBatchId,
    )
    const ag37LawManualReprintReviewIndexText = (await exists(paths.ag37LawManualReprintReviewIndexMd))
      ? await readText(paths.ag37LawManualReprintReviewIndexMd)
      : ''
    const ag37LawManualReprintSelfReviewText = (await exists(paths.ag37LawManualReprintSelfReviewMd))
      ? await readText(paths.ag37LawManualReprintSelfReviewMd)
      : ''
    const ag37LawManualReprintPocSummaryText = (await exists(paths.pocStatusSummaryMd))
      ? await readText(paths.pocStatusSummaryMd)
      : ''
    const ag37LawManualReprintReviewIndexReady =
      ag37LawManualReprintReviewIndexText.length > 0 &&
      ag37LawManualReprintBatchIds.every((batchId) =>
        ag37LawManualReprintReviewIndexText.includes(batchId),
      )
    const ag37LawManualReprintSelfReviewReady =
      ag37LawManualReprintSelfReviewText.length > 0 &&
      ag37LawManualReprintBatchIds.every((batchId) =>
        ag37LawManualReprintSelfReviewText.includes(batchId),
      )
    const ag37LawManualReprintReviewArtifactsPresent =
      ag37LawManualReprintReviewIndexReady && ag37LawManualReprintSelfReviewReady
    const ag37LawManualReprintPocSummaryReady =
      ag37LawManualReprintPocSummaryText.includes(
        'docs/review/ag37_law_manual_reprint_review_index.md',
      ) &&
      ag37LawManualReprintPocSummaryText.includes(
        'docs/review/ag37_law_manual_reprint_self_review.md',
      ) &&
      ag37LawManualReprintPocSummaryText.includes('95 review indexes')
    if (ag37LawManualReprintReviewArtifactsPresent && !ag37LawManualReprintPocSummaryReady) {
      problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing AG 37 Law Manual reprint review index reference')
    }
    if (ag37LawManualReprintReviewIndexReady) {
      console.log(
        `- AG 37 Law Manual reprint review index verified: ${ag37LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    if (ag37LawManualReprintSelfReviewReady) {
      console.log(
        `- AG 37 Law Manual reprint self-review verified: ${ag37LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    console.log(
      `- AG 37 Law Manual reprint plan verified: ${ag37LawManualReprintBatchPlan.proposedBatches.length} batches`,
    )
    if (ag38ReviewArtifactsPresent) {
    ...
    await validateAg18PlanMarkdown(
      paths.ag38LawManualReprintExtractionPlanMd,
      'docs/processor/ag38_law_manual_reprint_extraction_plan.md',
    )
    const ag38LawManualReprintBatchPlan = await readJson(paths.ag38LawManualReprintBatchPlanJson)
    const ag38LawManualReprintBatchIds = ag38LawManualReprintBatchPlan.proposedBatches.map(
      (batch) => batch.plannedBatchId,
    )
    const ag38LawManualReprintReviewIndexText = (await exists(paths.ag38LawManualReprintReviewIndexMd))
      ? await readText(paths.ag38LawManualReprintReviewIndexMd)
      : ''
    const ag38LawManualReprintSelfReviewText = (await exists(paths.ag38LawManualReprintSelfReviewMd))
      ? await readText(paths.ag38LawManualReprintSelfReviewMd)
      : ''
    const ag38LawManualReprintPocSummaryText = (await exists(paths.pocStatusSummaryMd))
      ? await readText(paths.pocStatusSummaryMd)
      : ''
    const ag38LawManualReprintReviewIndexReady =
      ag38LawManualReprintReviewIndexText.length > 0 &&
      ag38LawManualReprintBatchIds.every((batchId) =>
        ag38LawManualReprintReviewIndexText.includes(batchId),
      )
    const ag38LawManualReprintSelfReviewReady =
      ag38LawManualReprintSelfReviewText.length > 0 &&
      ag38LawManualReprintBatchIds.every((batchId) =>
        ag38LawManualReprintSelfReviewText.includes(batchId),
      )
    const ag38LawManualReprintReviewArtifactsPresent =
      ag38LawManualReprintReviewIndexReady && ag38LawManualReprintSelfReviewReady
    const ag38LawManualReprintPocSummaryReady =
      ag38LawManualReprintPocSummaryText.includes(
        'docs/review/ag38_law_manual_reprint_review_index.md',
      ) &&
      ag38LawManualReprintPocSummaryText.includes(
        'docs/review/ag38_law_manual_reprint_self_review.md',
      ) &&
      ag38LawManualReprintPocSummaryText.includes('98 review indexes')
    if (ag38LawManualReprintReviewArtifactsPresent && !ag38LawManualReprintPocSummaryReady) {
      problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing AG 38 Law Manual reprint review index reference')
    }
    if (ag38LawManualReprintReviewIndexReady) {
      console.log(
        `- AG 38 Law Manual reprint review index verified: ${ag38LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    if (ag38LawManualReprintSelfReviewReady) {
      console.log(
        `- AG 38 Law Manual reprint self-review verified: ${ag38LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    console.log(
      `- AG 38 Law Manual reprint plan verified: ${ag38LawManualReprintBatchPlan.proposedBatches.length} batches`,
    )
    if (ag48ReviewArtifactsPresent) {
    ...
    await validateAg18PlanMarkdown(
      paths.ag48LawManualReprintExtractionPlanMd,
      'docs/processor/ag48_law_manual_reprint_extraction_plan.md',
    )
    const ag48LawManualReprintBatchPlan = await readJson(paths.ag48LawManualReprintBatchPlanJson)
    const ag48LawManualReprintBatchIds = ag48LawManualReprintBatchPlan.proposedBatches.map(
      (batch) => batch.plannedBatchId,
    )
    const ag48LawManualReprintReviewIndexText = (await exists(paths.ag48LawManualReprintReviewIndexMd))
      ? await readText(paths.ag48LawManualReprintReviewIndexMd)
      : ''
    const ag48LawManualReprintSelfReviewText = (await exists(paths.ag48LawManualReprintSelfReviewMd))
      ? await readText(paths.ag48LawManualReprintSelfReviewMd)
      : ''
    const ag48LawManualReprintPocSummaryText = (await exists(paths.pocStatusSummaryMd))
      ? await readText(paths.pocStatusSummaryMd)
      : ''
    const ag48LawManualReprintReviewIndexReady =
      ag48LawManualReprintReviewIndexText.length > 0 &&
      ag48LawManualReprintBatchIds.every((batchId) =>
        ag48LawManualReprintReviewIndexText.includes(batchId),
      )
    const ag48LawManualReprintSelfReviewReady =
      ag48LawManualReprintSelfReviewText.length > 0 &&
      ag48LawManualReprintBatchIds.every((batchId) =>
        ag48LawManualReprintSelfReviewText.includes(batchId),
      )
    const ag48LawManualReprintReviewArtifactsPresent =
      ag48LawManualReprintReviewIndexReady && ag48LawManualReprintSelfReviewReady
    const ag48LawManualReprintPocSummaryReady =
      ag48LawManualReprintPocSummaryText.includes(
        'docs/review/ag48_law_manual_reprint_review_index.md',
      ) &&
      ag48LawManualReprintPocSummaryText.includes(
        'docs/review/ag48_law_manual_reprint_self_review.md',
      ) &&
      ag48LawManualReprintPocSummaryText.includes('96 review indexes')
    if (ag48LawManualReprintReviewArtifactsPresent && !ag48LawManualReprintPocSummaryReady) {
      problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing AG 48 Law Manual reprint review index reference')
    }
    if (ag48LawManualReprintReviewIndexReady) {
      console.log(
        `- AG 48 Law Manual reprint review index verified: ${ag48LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    if (ag48LawManualReprintSelfReviewReady) {
      console.log(
        `- AG 48 Law Manual reprint self-review verified: ${ag48LawManualReprintBatchPlan.proposedBatches.length} batches`,
      )
    }
    console.log(
      `- AG 48 Law Manual reprint plan verified: ${ag48LawManualReprintBatchPlan.proposedBatches.length} batches`,
    )
    if (ag39ReviewArtifactsPresent) {
  ...
  await validateReg102PlanMarkdown(paths.reg151ExtractionPlanMd, 'docs/processor/reg151_extraction_plan.md')
  const reg151BatchPlan = await readJson(paths.reg151BatchPlanJson)
  const reg151BatchIds = reg151BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg151ReviewIndexText = (await exists(paths.reg151ReviewIndexMd))
    ? await readText(paths.reg151ReviewIndexMd)
    : ''
  const reg151SelfReviewText = (await exists(paths.reg151SelfReviewMd))
    ? await readText(paths.reg151SelfReviewMd)
    : ''
  const reg151PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg151ReviewIndexReady =
    reg151ReviewIndexText.length > 0 && reg151BatchIds.every((batchId) => reg151ReviewIndexText.includes(batchId))
  const reg151SelfReviewReady =
    reg151SelfReviewText.length > 0 && reg151BatchIds.every((batchId) => reg151SelfReviewText.includes(batchId))
  const reg151ReviewArtifactsPresent = reg151ReviewIndexReady && reg151SelfReviewReady
  const reg151PocSummaryReady =
    reg151PocSummaryText.includes('docs/review/reg151_review_index.md') &&
    reg151PocSummaryText.includes('docs/review/reg151_self_review.md') &&
    reg151PocSummaryText.includes('94 review indexes')
  if (reg151ReviewArtifactsPresent && !reg151PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 151 review index reference')
  }
  if (reg151ReviewIndexReady) {
    console.log(`- Reg 151 review index verified: ${reg151BatchPlan.proposedBatches.length} batches`)
  }
  if (reg151SelfReviewReady) {
    console.log(`- Reg 151 self-review verified: ${reg151BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 151 plan verified: ${reg151BatchPlan.proposedBatches.length} batches`)
  await validateReg102PlanMarkdown(paths.reg147ExtractionPlanMd, 'docs/processor/reg147_extraction_plan.md')
  const reg147BatchPlan = await readJson(paths.reg147BatchPlanJson)
  const reg147BatchIds = reg147BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg147ReviewIndexText = (await exists(paths.reg147ReviewIndexMd))
    ? await readText(paths.reg147ReviewIndexMd)
    : ''
  const reg147SelfReviewText = (await exists(paths.reg147SelfReviewMd))
    ? await readText(paths.reg147SelfReviewMd)
    : ''
  const reg147PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg147ReviewIndexReady =
    reg147ReviewIndexText.length > 0 && reg147BatchIds.every((batchId) => reg147ReviewIndexText.includes(batchId))
  const reg147SelfReviewReady =
    reg147SelfReviewText.length > 0 && reg147BatchIds.every((batchId) => reg147SelfReviewText.includes(batchId))
  const reg147ReviewArtifactsPresent = reg147ReviewIndexReady && reg147SelfReviewReady
  const reg147PocSummaryReady =
    reg147PocSummaryText.includes('docs/review/reg147_review_index.md') &&
    reg147PocSummaryText.includes('docs/review/reg147_self_review.md') &&
    reg147PocSummaryText.includes('93 review indexes')
  if (reg147ReviewArtifactsPresent && !reg147PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 147 review index reference')
  }
  if (reg147ReviewIndexReady) {
    console.log(`- Reg 147 review index verified: ${reg147BatchPlan.proposedBatches.length} batches`)
  }
  if (reg147SelfReviewReady) {
    console.log(`- Reg 147 self-review verified: ${reg147BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 147 plan verified: ${reg147BatchPlan.proposedBatches.length} batches`)
  await validateReg102PlanMarkdown(paths.reg126ExtractionPlanMd, 'docs/processor/reg126_extraction_plan.md')
  const reg126BatchPlan = await readJson(paths.reg126BatchPlanJson)
  const reg126BatchIds = reg126BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg126ReviewIndexText = (await exists(paths.reg126ReviewIndexMd))
    ? await readText(paths.reg126ReviewIndexMd)
    : ''
  const reg126SelfReviewText = (await exists(paths.reg126SelfReviewMd))
    ? await readText(paths.reg126SelfReviewMd)
    : ''
  const reg126PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg126ReviewIndexReady =
    reg126ReviewIndexText.length > 0 && reg126BatchIds.every((batchId) => reg126ReviewIndexText.includes(batchId))
  const reg126SelfReviewReady =
    reg126SelfReviewText.length > 0 && reg126BatchIds.every((batchId) => reg126SelfReviewText.includes(batchId))
  const reg126ReviewArtifactsPresent = reg126ReviewIndexReady && reg126SelfReviewReady
  const reg126PocSummaryReady =
    reg126PocSummaryText.includes('docs/review/reg126_review_index.md') &&
    reg126PocSummaryText.includes('docs/review/reg126_self_review.md') &&
    reg126PocSummaryText.includes('92 review indexes')
  if (reg126ReviewArtifactsPresent && !reg126PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 126 review index reference')
  }
  if (reg126ReviewIndexReady) {
    console.log(`- Reg 126 review index verified: ${reg126BatchPlan.proposedBatches.length} batches`)
  }
  if (reg126SelfReviewReady) {
    console.log(`- Reg 126 self-review verified: ${reg126BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 126 plan verified: ${reg126BatchPlan.proposedBatches.length} batches`)
  await validateReg102PlanMarkdown(paths.reg056ExtractionPlanMd, 'docs/processor/reg056_extraction_plan.md')
  const reg056BatchPlan = await readJson(paths.reg056BatchPlanJson)
  const reg056BatchIds = reg056BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg056ReviewIndexText = (await exists(paths.reg056ReviewIndexMd))
    ? await readText(paths.reg056ReviewIndexMd)
    : ''
  const reg056SelfReviewText = (await exists(paths.reg056SelfReviewMd))
    ? await readText(paths.reg056SelfReviewMd)
    : ''
  const reg056PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg056ReviewIndexReady =
    reg056ReviewIndexText.length > 0 && reg056BatchIds.every((batchId) => reg056ReviewIndexText.includes(batchId))
  const reg056SelfReviewReady =
    reg056SelfReviewText.length > 0 && reg056BatchIds.every((batchId) => reg056SelfReviewText.includes(batchId))
  const reg056ReviewArtifactsPresent = reg056ReviewIndexReady && reg056SelfReviewReady
  const reg056PocSummaryReady =
    reg056PocSummaryText.includes('docs/review/reg056_review_index.md') &&
    reg056PocSummaryText.includes('docs/review/reg056_self_review.md') &&
    reg056PocSummaryText.includes('91 review indexes')
  if (reg056ReviewArtifactsPresent && !reg056PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 56 review index reference')
  }
  if (reg056ReviewIndexReady) {
    console.log(`- Reg 56 review index verified: ${reg056BatchPlan.proposedBatches.length} batches`)
  }
  if (reg056SelfReviewReady) {
    console.log(`- Reg 56 self-review verified: ${reg056BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 56 plan verified: ${reg056BatchPlan.proposedBatches.length} batches`)
  await validateReg102PlanMarkdown(paths.reg143ExtractionPlanMd, 'docs/processor/reg143_extraction_plan.md')
  const reg143BatchPlan = await readJson(paths.reg143BatchPlanJson)
  const reg143BatchIds = reg143BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg143ReviewIndexText = (await exists(paths.reg143ReviewIndexMd))
    ? await readText(paths.reg143ReviewIndexMd)
    : ''
  const reg143SelfReviewText = (await exists(paths.reg143SelfReviewMd))
    ? await readText(paths.reg143SelfReviewMd)
    : ''
  const reg143PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg143ReviewIndexReady =
    reg143ReviewIndexText.length > 0 && reg143BatchIds.every((batchId) => reg143ReviewIndexText.includes(batchId))
  const reg143SelfReviewReady =
    reg143SelfReviewText.length > 0 && reg143BatchIds.every((batchId) => reg143SelfReviewText.includes(batchId))
  const reg143ReviewArtifactsPresent = reg143ReviewIndexReady && reg143SelfReviewReady
  const reg143PocSummaryReady =
    reg143PocSummaryText.includes('docs/review/reg143_review_index.md') &&
    reg143PocSummaryText.includes('docs/review/reg143_self_review.md') &&
    reg143PocSummaryText.includes('90 review indexes')
  if (reg143ReviewArtifactsPresent && !reg143PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 143 review index reference')
  }
  if (reg143ReviewIndexReady) {
    console.log(`- Reg 143 review index verified: ${reg143BatchPlan.proposedBatches.length} batches`)
  }
  if (reg143SelfReviewReady) {
    console.log(`- Reg 143 self-review verified: ${reg143BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 143 plan verified: ${reg143BatchPlan.proposedBatches.length} batches`)
  await validateReg102PlanMarkdown(paths.reg136ExtractionPlanMd, 'docs/processor/reg136_extraction_plan.md')
  const reg136BatchPlan = await readJson(paths.reg136BatchPlanJson)
  const reg136BatchIds = reg136BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg136ReviewIndexText = (await exists(paths.reg136ReviewIndexMd))
    ? await readText(paths.reg136ReviewIndexMd)
    : ''
  const reg136SelfReviewText = (await exists(paths.reg136SelfReviewMd))
    ? await readText(paths.reg136SelfReviewMd)
    : ''
  const reg136PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg136ReviewIndexReady =
    reg136ReviewIndexText.length > 0 && reg136BatchIds.every((batchId) => reg136ReviewIndexText.includes(batchId))
  const reg136SelfReviewReady =
    reg136SelfReviewText.length > 0 && reg136BatchIds.every((batchId) => reg136SelfReviewText.includes(batchId))
  const reg136ReviewArtifactsPresent = reg136ReviewIndexReady && reg136SelfReviewReady
  const reg136PocSummaryReady =
    reg136PocSummaryText.includes('docs/review/reg136_review_index.md') &&
    reg136PocSummaryText.includes('docs/review/reg136_self_review.md') &&
    reg136PocSummaryText.includes('89 review indexes')
  if (reg136ReviewArtifactsPresent && !reg136PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 136 review index reference')
  }
  if (reg136ReviewIndexReady) {
    console.log(`- Reg 136 review index verified: ${reg136BatchPlan.proposedBatches.length} batches`)
  }
  if (reg136SelfReviewReady) {
    console.log(`- Reg 136 self-review verified: ${reg136BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 136 plan verified: ${reg136BatchPlan.proposedBatches.length} batches`)
  await validateReg102PlanMarkdown(paths.reg179ExtractionPlanMd, 'docs/processor/reg179_extraction_plan.md')
  const reg179BatchPlan = await readJson(paths.reg179BatchPlanJson)
  const reg179BatchIds = reg179BatchPlan.proposedBatches.map((batch) => batch.plannedBatchId)
  const reg179ReviewIndexText = (await exists(paths.reg179ReviewIndexMd))
    ? await readText(paths.reg179ReviewIndexMd)
    : ''
  const reg179SelfReviewText = (await exists(paths.reg179SelfReviewMd))
    ? await readText(paths.reg179SelfReviewMd)
    : ''
  const reg179PocSummaryText = (await exists(paths.pocStatusSummaryMd))
    ? await readText(paths.pocStatusSummaryMd)
    : ''
  const reg179ReviewIndexReady =
    reg179ReviewIndexText.length > 0 && reg179BatchIds.every((batchId) => reg179ReviewIndexText.includes(batchId))
  const reg179SelfReviewReady =
    reg179SelfReviewText.length > 0 && reg179BatchIds.every((batchId) => reg179SelfReviewText.includes(batchId))
  const reg179ReviewArtifactsPresent = reg179ReviewIndexReady && reg179SelfReviewReady
  const reg179PocSummaryReady =
    reg179PocSummaryText.includes('docs/review/reg179_review_index.md') &&
    reg179PocSummaryText.includes('docs/review/reg179_self_review.md') &&
    reg179PocSummaryText.includes('88 review indexes')
  if (reg179ReviewArtifactsPresent && !reg179PocSummaryReady) {
    problems.push('docs/review/valuation_regulation_repository_poc_status.md: missing Reg 179 review index reference')
  }
  if (reg179ReviewIndexReady) {
    console.log(`- Reg 179 review index verified: ${reg179BatchPlan.proposedBatches.length} batches`)
  }
  if (reg179SelfReviewReady) {
    console.log(`- Reg 179 self-review verified: ${reg179BatchPlan.proposedBatches.length} batches`)
  }
  console.log(`- Reg 179 plan verified: ${reg179BatchPlan.proposedBatches.length} batches`)
