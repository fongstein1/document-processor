...
const targetDefinitions = [
  ...
  ['vm-01', 'VM-01 Definitions', 'valuation_manual_pdfs', 'P0', 'current', 'The current 2026 VM-01 terminology layer contains 98 exact-text definition units. The final retrieval-metric and evidence-window correction is complete without source-evidence changes; it remains review-only and not promoted.', 'Run only the final narrow review of strict top-three retrieval and support-window consistency, then record a separate promotion decision only if approved.'],
...
const buildCompleteness = (inventory) => {
  ...
  return [
    ...
    `- VM-01 promotion status: ${s.vm01PromotionStatus}; final narrow review remains required after the strict top-three retrieval correction.`,
