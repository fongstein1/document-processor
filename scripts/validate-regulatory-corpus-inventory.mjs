...
const main = async () => {
  ...
  if (tableTarget?.assessment !== 'review_candidate_partial_vm20_appendix2' || tableTarget.evidenceSourceIds.length !== 7) fail('Current regulatory-table target does not reflect the review-only VM-20 Appendix 2 proof of concept.')
  if (inventory.summary.structuredTableLogicalTables !== 7 || inventory.summary.structuredTableVersions !== 29 || inventory.summary.structuredTableRows !== 891 || inventory.summary.structuredTableValues !== 7022 || inventory.summary.structuredTablePromotionStatus !== 'not_promoted') fail('Structured-table inventory summary is inconsistent.')
