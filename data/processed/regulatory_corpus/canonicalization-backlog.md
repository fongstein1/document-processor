...
| 11 | P1 | Standard Valuation Law / Model #820 | reviewed_not_canonical | Add the authorized model-law source for interpretation and applicability context. |
| 12 | P1 | Current Valuation Manual amendments and change material | review_artifact_only | Inventory authorized current amendments and preserve version/effective-date relationships. |
| 13 | P1 | Valuation Manual Maintenance Agenda and amendment proposals | missing | Keep proposed material separate and explicitly non-controlling. |
| 14 | P1 | VM-02 Nonforfeiture Requirements | reviewed_not_canonical | Canonicalize after the P0 manual chapters. |
| 15 | P1 | VM-50 PBR Experience Reporting | missing | Confirm current source and add as reporting support. |
| 16 | P1 | VM-51 PBR Experience Reporting Tables | missing | Treat as structured reporting/table material. |
| 17 | P1 | VM-A Actuarial Opinion and Memorandum appendix | reviewed_not_canonical | Confirm current appendix scope and canonicalize with VM-30 cross-references. |
| 18 | P1 | VM-M valuation manual material | missing | Confirm whether this is in near-term life/annuity scope before intake. |
| 19 | P1 | VM-V valuation manual material | missing | Confirm whether this is in near-term life/annuity scope before intake. |
| 20 | P2 | Actuarial practice notes and educational notes | canonical_partial | Canonicalize selectively when it answers likely implementation questions without replacing authority. |
| 21 | P2 | Targeted historical Valuation Manual editions | review_artifact_only | Add only where version-aware retrieval requires historical comparison. |
| 22 | P2 | Implementation FAQs | review_artifact_only | Keep FAQ material companion-only and source-bound. |
| 23 | P2 | Jurisdiction-specific deviations from model requirements | reviewed_not_canonical | Add documentary deviations with jurisdiction and effective-date evidence. |
| 24 | P2 | Law Manual reprints | canonical_partial | Track as reprints/companions only after human disposition. |
| 25 | P2 | New York valuation regulations and amendments | reviewed_not_canonical | Prioritize jurisdictional deviations after P0 current NAIC chapters. |
| 26 | P2 | Relevant statutory accounting guidance | missing | Add targeted guidance only where it directly changes a valuation or reporting answer. |
| 27 | P3 | Health-specific Valuation Manual material | reviewed_not_canonical | Defer unless scope expands. |
