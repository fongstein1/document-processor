...
| 3 | P0 | VM-01 Definitions | canonical_review_candidate | Run only the final code-level review of the hashed implementation snapshots, then record a separate promotion decision only if approved. |
