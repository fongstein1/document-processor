...
| 3 | P0 | VM-01 Definitions | canonical_review_candidate | Run only the final narrow review of strict top-three retrieval and support-window consistency, then record a separate promotion decision only if approved. |
