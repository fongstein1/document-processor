...
- **vm-20 — VM-20 Requirements for Principle-Based Reserves for Life Products:** canonical_partial. VM-20 now has a 247-chunk review-only coverage set: 72 current-manual chunks across the existing slices and expanded batches, plus 175 separately labeled companion-guidance chunks; it is still not a complete current chapter package. Next: Review the dedicated VM-20 package, then complete authoritative Sections 4, 5, and 9 plus Appendices 1-2 and structured current tables.
