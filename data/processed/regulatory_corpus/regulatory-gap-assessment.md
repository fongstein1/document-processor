...
- **vm-30 — VM-30 Actuarial Opinion and Memorandum Requirements:** canonical_review_candidate. The current 2026 VM-30 review candidate contains 8 structural parents and 43 exact-text child units across the complete chapter boundary. Its 16 documentary relationship candidates and all downstream uses remain separately governed. Next: Obtain independent source and actuarial review; do not promote or export before a separate approval decision.
