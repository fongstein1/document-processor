...
- **vm-31 — VM-31 PBR Actuarial Report Requirements:** canonical_review_candidate. Current 2026 VM-31 is represented by one substantially complete review-only package with 9 structural parents and 75 exact-text child units. Next: Send the source package, retrieval evaluation, source QA, relationship registry, and review package for independent review; do not promote or begin another chapter until disposition.
