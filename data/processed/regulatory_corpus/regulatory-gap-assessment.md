...
- **vm-01 — VM-01 Definitions:** canonical_review_candidate. The current 2026 VM-01 terminology layer contains 98 exact-text definition units. Its two independent-review blockers are corrected without source-evidence changes; it remains review-only and not promoted. Next: Run the narrow final review of source-explicit definedTerms and the case-level retrieval artifact, then record a separate promotion decision only if approved.
