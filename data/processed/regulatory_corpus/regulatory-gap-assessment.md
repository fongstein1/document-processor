...
- **vm-01 — VM-01 Definitions:** canonical_review_candidate. The current 2026 VM-01 terminology layer contains 98 exact-text definition units. The final retrieval-metric and evidence-window correction is complete without source-evidence changes; it remains review-only and not promoted. Next: Run only the final narrow review of strict top-three retrieval and support-window consistency, then record a separate promotion decision only if approved.
