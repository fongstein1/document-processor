...
- **vm-20 — VM-20 Requirements for Principle-Based Reserves for Life Products:** canonical_partial. VM-20 has extensive reviewed slices and four canonical POC packages, but not a complete chapter package. Next: Expand the existing reviewed VM-20 slices into a hierarchical chapter package.
