...
- **current-regulatory-tables — Current prescribed valuation, mortality, spread, and default tables:** review_candidate_partial_vm20_appendix2. A review-only VM-20 Appendix 2 proof of concept now covers official current Tables A, F, G, H, I, J, and K with workbook/sheet/cell citations; Tables B-E2 and all non-VM-20 tables remain gaps. Next: Complete independent review of the Appendix 2 proof of concept, then record a separate table promotion decision or fixes; continue other table families separately.
