...
| `table-f-average-explicit-source-summary` | supported_review_only | `source_summary_statistic_found` |
| `table-g-average-regulatory-exclusion` | unsupported | `source_summary_not_regulatory_dimension` |
| `table-g-average-explicit-source-summary` | supported_review_only | `source_summary_statistic_found` |
| `table-h-average-regulatory-exclusion` | unsupported | `source_summary_not_regulatory_dimension` |
| `table-h-average-explicit-source-summary` | supported_review_only | `source_summary_statistic_found` |
| `table-i-average-regulatory-exclusion` | unsupported | `source_summary_not_regulatory_dimension` |
| `table-i-average-explicit-source-summary` | supported_review_only | `source_summary_statistic_found` |
| `table-j-average-regulatory-exclusion` | unsupported | `source_summary_not_regulatory_dimension` |
| `table-j-average-explicit-source-summary` | supported_review_only | `source_summary_statistic_found` |
| `table-j-current-short-tenor` | supported_review_only | `exact_structured_value_found` |
| `table-j-long-term-short-tenor` | supported_review_only | `exact_structured_value_found` |
| `table-j-ambiguous-measure` | ambiguous | `ambiguous_requires_more_context` |
| `table-j-january-current-note-scope` | supported_review_only | `exact_structured_value_found` |
| `table-j-january-long-term-note-exclusion` | supported_review_only | `exact_structured_value_found` |
| `table-j-january-unrelated-maturity-note-exclusion` | supported_review_only | `exact_structured_value_found` |
| `table-j-later-version-note-exclusion` | supported_review_only | `exact_structured_value_found` |
