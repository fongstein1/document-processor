...
Source summary:
- Source file: `NY Regulations/2021 VLM Report_DRAFT-(1-27-2020) with academy Updates V1-Reg-136-11-NYCRR-S043.pdf`
...
- Planning commit: `8e45bf5` (`Add Regulation 136 planning layer`)

Overall wave summary:
- The Regulation 136 wave is complete as a single 23-page, review-only slice.
- The batch stayed source-bound and kept the title page, market-value-adjustment formula language, noncompliance, and severability material together.
- The formula-heavy middle pages remain part of the same review-only unit rather than a separate promotion target.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `batch-271` | pages 1-23; title page, market-value adjustment formula, noncompliance, and severability | Regulation 136 purpose, market-value adjustment formula, noncompliance, and severability | Keep the full 23-page regulation together as one bounded slice and stop at the page 23 boundary. | `state_regulation`, `jurisdiction_specific_requirement`, `regulatory_requirement`, `reporting_requirement`, `documentation_expectation`, `governance_or_control_expectation`, `calculation_structure`, `definition_or_terminology`, `cross_reference_mapping`, `background_content`, `boundary_control_window`, `requires_human_interpretation` | `reasonable_with_minor_cautions` | Noisy OCR-like text layer; page-image wording backstop; page locators primary; cross-reference mapping should remain non-interpretive | Passed | `8e45bf5` |
...
- The title page, market-value-adjustment formula language, and severability closeout should remain separate from any later cleanup pass.
- The formula-heavy middle pages should remain visible as part of the same review-only slice instead of being widened into a separate wave.
...
- Are the title page, the market-value-adjustment formula language, and the severability closeout kept together only because the slice is intentionally narrow?
- Are the Insurance Law and market-value-adjustment references treated as cross-reference context, not substantive guidance?
- Is the page-image backstop visible for the title page, the formula-heavy middle pages, and the severability closeout?
...
2. Market-value adjustment formula and noncompliance language.
3. Formula-heavy middle pages.
