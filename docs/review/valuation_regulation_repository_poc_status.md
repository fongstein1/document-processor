...
The handoff now spans 21 review indexes.
...
- the scaffold reports 94 batches validated
...
- Reviewers should start from the twenty-one review indexes listed above.
