# Controlled Regulation 136 Extraction Plan
...
- primary source file: `NY Regulations/2021 VLM Report_DRAFT-(1-27-2020) with academy Updates V1-Reg-136-11-NYCRR-S043.pdf`
...
- `reg136-opening-purpose-market-value-adjustment-formula-and-severability`, pages 1-23: title page, market-value adjustment formula, noncompliance, and severability.

Boundaries:

- Keep planning focused on this single Regulation 136 PDF.
- Do not widen into AG files, practice notes, or other NY regulation files in the same wave.
- Keep the purpose / formula / noncompliance / severability language review-only until a human confirms the indexing decision.
...
| --- | --- | --- | --- | --- |
| `reg136-opening-purpose-market-value-adjustment-formula-and-severability` | Purpose, market-value adjustment formula, noncompliance, and severability | High | state_regulation, jurisdiction_specific_requirement, regulatory_requirement, reporting_requirement, documentation_expectation, governance_or_control_expectation, calculation_structure, definition_or_terminology, cross_reference_mapping, background_content, boundary_control_window, requires_human_interpretation | Insurance Law sections 4217, 4221, 4222, 4510, 4511, 4517, 4518; market-value adjustment formula; cash surrender value; nonforfeiture; severability |

## Proposed Batch Sequence

| Planned batch | Section / topic | Page target | Rationale | Review complexity |
| --- | --- | --- | --- | --- |
| `batch-271` | Regulation 136 purpose, market-value adjustment formula, noncompliance, and severability | 1-23 | Capture the full 23-page regulation as a single review-only slice and stop at the page 23 boundary. | High |
...
- Market-value adjustment text that directly changes insurer treatment.

### What counts as terminology or interpretation

- `market-value adjustment`, `cash surrender value`, `noncompliance`, and related terms.
- The note's explanation of how the opening sections should be indexed for review.

### What counts as cross-reference mapping

- References to Insurance Law sections or market-value adjustment concepts without expanding beyond the page window.
...
- The formula-heavy middle pages.
...
- `batch-271` should remain the only planned batch for this source.
- The plan should stay locked to pages 1-23 and should not absorb other NY regulation files.
- The page-image wording backstop should stay visible in both the plan and the review packet.

## Operating Note

- Regulation 136 is a narrow, review-only NY regulation wave.
